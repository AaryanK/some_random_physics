...
def run(c, truth, f,outfilename, nmax=-1):
    ...
    for i, event in enumerate(c):
        ...
        for index, particle in enumerate(truth.PDG):
            ...
            if truth.PDG[index] == 13:
                ...
                if in_between(x_lar_start,x_lar_end,y_lar_start,y_lar_end,z_lar_start,z_lar_end) and KE_muon>500:
                    ...
                    if inside_lar(x_start,y_start,z_start) and inside_tms(x_end,y_end,z_end):
                        ...
                        if signed_dist!=None:
                            ...
                            if signed_dist > 0 :
                                n_correct+=1
                                print("Muon Identified")
                                print(n_correct/n_true_muons)
                                muon_correct_charge[1].append(n_correct/n_true_muons)
                                muon_correct_charge[0].append(KE_muon)
    ...
    return muon_signed_distances,amuon_signed_distances,muon_correct_charge,amuon_correct_charge
